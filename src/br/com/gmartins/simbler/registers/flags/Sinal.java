 ...
 * Flag Sinal.
 * 
 * This flag is activated when the last operation results in a negative number. (It is set to one)
 * Otherwise, it's set to zero.
 * 
 * @author Guilherme
 */
public class Sinal extends Registradores implements Signalizable {

    /**
     * Build a new register linked with the specified label.
     * @param lbl The linked label.
     */
    public Sinal(JLabel lbl, MainPanel panel) {
        super(panel);
