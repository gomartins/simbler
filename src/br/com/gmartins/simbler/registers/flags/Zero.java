 ...
 * Flag Zero.
 * 
 * This flag is activated when the last operation results in Zero. (It is set to one)
 * Otherwise, it's set to zero.
 * 
 * @author Guilherme
 */
public class Zero extends Registradores implements Signalizable {

    /**
     * Build a new register linked with the specified label.
     * @param lbl The linked label.
     */
    public Zero(JLabel lbl, MainPanel panel) {
        super(panel);
