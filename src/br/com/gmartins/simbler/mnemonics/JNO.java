...
public class JNO extends Commands {
    ...
    public void execute() {
        ...
        if (RegexMatcher.matches(regex0, getCurrentInstruction().getLineCommand())) {
            ...
            // Se o valor do registrador Overflow estiver em "0", indica que a última operação não estourou. Então pula.
            if (value == 0) {
                // Define a posição da linha com o valor definido no comando JNO
